...
var templates = map[string]verticalTemplate{
	"movie-production": {
		...
		Users: []DemoUser{
			...
			{Name: "Priya Sharma", Email: "priya@{slug}.demo", Role: "manager", Department: "Production"},
			{Name: "Arun Nair", Email: "arun@{slug}.demo", Role: "coordinator", Department: "Production"},
			{Name: "Meena Iyer", Email: "meena@{slug}.demo", Role: "accountant", Department: "Finance"},
			{Name: "Vikram Reddy", Email: "vikram@{slug}.demo", Role: "project_supervisor", Department: "Production"},
			{Name: "Deepa Menon", Email: "deepa@{slug}.demo", Role: "member", Department: "Camera"},
			{Name: "Karthik Rajan", Email: "karthik@{slug}.demo", Role: "member", Department: "Art"},
			{Name: "Ananya Das", Email: "ananya@{slug}.demo", Role: "member", Department: "Sound"},
		},
		Projects: []DemoProject{
	...
	"software-development": {
		...
		Users: []DemoUser{
			...
			{Name: "Sneha Patel", Email: "sneha@{slug}.demo", Role: "manager", Department: "Delivery"},
			{Name: "Rohan Gupta", Email: "rohan@{slug}.demo", Role: "coordinator", Department: "Engineering"},
			{Name: "Kavita Joshi", Email: "kavita@{slug}.demo", Role: "accountant", Department: "Finance"},
			{Name: "Amit Verma", Email: "amit@{slug}.demo", Role: "member", Department: "Backend"},
			{Name: "Pooja Singh", Email: "pooja@{slug}.demo", Role: "member", Department: "Frontend"},
			{Name: "Rahul Khanna", Email: "rahul@{slug}.demo", Role: "member", Department: "QA"},
		},
		Projects: []DemoProject{
	...
	"construction": {
		...
		Users: []DemoUser{
			...
			{Name: "Lakshmi Rao", Email: "lakshmi@{slug}.demo", Role: "manager", Department: "Projects"},
			{Name: "Mohan Das", Email: "mohan@{slug}.demo", Role: "coordinator", Department: "Site Management"},
			{Name: "Geeta Nair", Email: "geeta@{slug}.demo", Role: "accountant", Department: "Finance"},
			{Name: "Ravi Shankar", Email: "ravi@{slug}.demo", Role: "member", Department: "Civil"},
			{Name: "Nandini Hegde", Email: "nandini@{slug}.demo", Role: "member", Department: "MEP"},
		},
		Projects: []DemoProject{
	...
	"events-management": {
		...
		Users: []DemoUser{
			...
			{Name: "Sanjay Desai", Email: "sanjay@{slug}.demo", Role: "manager", Department: "Accounts"},
			{Name: "Reema Choudhury", Email: "reema@{slug}.demo", Role: "coordinator", Department: "Production"},
			{Name: "Ajay Bhat", Email: "ajay@{slug}.demo", Role: "accountant", Department: "Finance"},
			{Name: "Divya Menon", Email: "divya@{slug}.demo", Role: "member", Department: "AV & Technical"},
			{Name: "Kiran Shetty", Email: "kiran@{slug}.demo", Role: "member", Department: "Logistics"},
		},
		Projects: []DemoProject{
