...
echo "    priya.sharma@xyzcba.com    executive_producer"
echo "    arun.nair@xyzcba.com       line_producer"
echo "    meena.iyer@xyzcba.com      production_accountant"
echo "    vikram.reddy@xyzcba.com    department_head"
echo "    deepa.menon@xyzcba.com     crew_member"
echo ""
